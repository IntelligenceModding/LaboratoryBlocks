...
For example, a change developed for Minecraft 26.1.1 with NeoForge should target the corresponding 26.1.1 NeoForge branch.
...
For example, the Minecraft 26.1.1 NeoForge branch uses Java 25.
