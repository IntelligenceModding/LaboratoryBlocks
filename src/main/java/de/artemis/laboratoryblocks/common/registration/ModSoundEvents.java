...
public class ModSoundEvents {
    ...
    private static RegistryObject<SoundEvent> register(String resourceLocation) {
        return Registration.SOUND_EVENTS.register(resourceLocation,  () -> SoundEvent.createVariableRangeEvent(ResourceLocation.tryBuild(LaboratoryBlocks.MOD_ID, resourceLocation)));
    }
