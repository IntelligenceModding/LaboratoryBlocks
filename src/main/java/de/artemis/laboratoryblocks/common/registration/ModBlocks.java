...
public class ModBlocks {
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_MANGROVE_LABORATORY_FLOOR = registerWithTab("enlighted_mangrove_laboratory_floor",
            () -> new LaboratoryBlock(ModBlocks.MANGROVE_LABORATORY_FLOOR, BlockBehaviour.Properties.of(Material.WOOD).strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_MANGROVE_LABORATORY_TILES = registerWithTab("enlighted_mangrove_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.MANGROVE_LABORATORY_TILES, BlockBehaviour.Properties.of(Material.WOOD).strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
