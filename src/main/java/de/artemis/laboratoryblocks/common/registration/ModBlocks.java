...
public class ModBlocks {
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_LABORATORY_PILLAR = register("enlighted_laboratory_pillar",
            () -> new LaboratoryBlock(ModBlocks.LABORATORY_PILLAR, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(SoundType.METAL).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_GRAY_LABORATORY_PILLAR = register("enlighted_gray_laboratory_pillar",
            () -> new LaboratoryBlock(ModBlocks.GRAY_LABORATORY_PILLAR, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(SoundType.METAL).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_CLEAR_LABORATORY_SCREEN = register("enlighted_clear_laboratory_screen",
            () -> new LaboratoryBlock(ModBlocks.CLEAR_LABORATORY_SCREEN, BlockBehaviour.Properties.of().strength(1.25F, 1.5F).sound(SoundType.METAL).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_LABORATORY_FAN = register("enlighted_laboratory_fan",
            () -> new LaboratoryBlock(ModBlocks.LABORATORY_FAN, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(SoundType.METAL).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_LEFT_FACED_BLUE_SIGNALING_LABORATORY_BLOCK = register("enlighted_left-faced_blue_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.LEFT_FACED_BLUE_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(SoundType.METAL).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_RIGHT_FACED_BLUE_SIGNALING_LABORATORY_BLOCK = register("enlighted_right-faced_blue_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.RIGHT_FACED_BLUE_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(SoundType.METAL).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_LEFT_FACED_RED_SIGNALING_LABORATORY_BLOCK = register("enlighted_left-faced_red_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.LEFT_FACED_RED_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(SoundType.METAL).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_RIGHT_FACED_RED_SIGNALING_LABORATORY_BLOCK = register("enlighted_right-faced_red_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.RIGHT_FACED_RED_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(SoundType.METAL).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_LEFT_FACED_GREEN_SIGNALING_LABORATORY_BLOCK = register("enlighted_left-faced_green_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.LEFT_FACED_GREEN_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(SoundType.METAL).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_RIGHT_FACED_GREEN_SIGNALING_LABORATORY_BLOCK = register("enlighted_right-faced_green_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.RIGHT_FACED_GREEN_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(SoundType.METAL).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_LABORATORY_VENT = register("enlighted_laboratory_vent",
            () -> new LaboratoryBlock(ModBlocks.LABORATORY_VENT, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(SoundType.METAL).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_PLA_BLOCK = register("enlighted_pla_block",
            () -> new LaboratoryBlock(ModBlocks.PLA_BLOCK, BlockBehaviour.Properties.of().strength(0.5F, 0.5F).sound(SoundType.SCAFFOLDING).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_PLA_TILES = register("enlighted_pla_tiles",
            () -> new LaboratoryBlock(ModBlocks.PLA_TILES, BlockBehaviour.Properties.of().strength(0.5F, 0.5F).sound(SoundType.SCAFFOLDING).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryCarpetBlock> ENLIGHTED_PLA_FLOORING = register("enlighted_pla_flooring",
            () -> new LaboratoryCarpetBlock(ModBlocks.PLA_FLOORING, BlockBehaviour.Properties.of().ignitedByLava().strength(0.1F).sound(SoundType.SCAFFOLDING).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryCarpetBlock> ENLIGHTED_TILED_PLA_FLOORING = register("enlighted_tiled_pla_flooring",
            () -> new LaboratoryCarpetBlock(ModBlocks.TILED_PLA_FLOORING, BlockBehaviour.Properties.of().ignitedByLava().strength(0.1F).sound(SoundType.SCAFFOLDING).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_LABORATORY_BLOCK = register("enlighted_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(SoundType.METAL).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_SCREWED_LABORATORY_BLOCK = register("enlighted_screwed_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.SCREWED_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(SoundType.METAL).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_LABORATORY_TILES = register("enlighted_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.LABORATORY_TILES, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(SoundType.METAL).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_GRAY_LABORATORY_TILES = register("enlighted_gray_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.GRAY_LABORATORY_TILES, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(SoundType.METAL).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_MIXED_LABORATORY_TILES = register("enlighted_mixed_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.MIXED_LABORATORY_TILES, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(SoundType.METAL).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_OAK_LABORATORY_FLOOR = register("enlighted_oak_laboratory_floor",
            () -> new LaboratoryBlock(ModBlocks.OAK_LABORATORY_FLOOR, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_SPRUCE_LABORATORY_FLOOR = register("enlighted_spruce_laboratory_floor",
            () -> new LaboratoryBlock(ModBlocks.SPRUCE_LABORATORY_FLOOR, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_BIRCH_LABORATORY_FLOOR = register("enlighted_birch_laboratory_floor",
            () -> new LaboratoryBlock(ModBlocks.BIRCH_LABORATORY_FLOOR, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_DARK_OAK_LABORATORY_FLOOR = register("enlighted_dark_oak_laboratory_floor",
            () -> new LaboratoryBlock(ModBlocks.DARK_OAK_LABORATORY_FLOOR, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_JUNGLE_LABORATORY_FLOOR = register("enlighted_jungle_laboratory_floor",
            () -> new LaboratoryBlock(ModBlocks.JUNGLE_LABORATORY_FLOOR, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_ACACIA_LABORATORY_FLOOR = register("enlighted_acacia_laboratory_floor",
            () -> new LaboratoryBlock(ModBlocks.ACACIA_LABORATORY_FLOOR, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_MANGROVE_LABORATORY_FLOOR = register("enlighted_mangrove_laboratory_floor",
            () -> new LaboratoryBlock(ModBlocks.MANGROVE_LABORATORY_FLOOR, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_CRIMSON_LABORATORY_FLOOR = register("enlighted_crimson_laboratory_floor",
            () -> new LaboratoryBlock(ModBlocks.CRIMSON_LABORATORY_FLOOR, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_WARPED_LABORATORY_FLOOR = register("enlighted_warped_laboratory_floor",
            () -> new LaboratoryBlock(ModBlocks.WARPED_LABORATORY_FLOOR, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryGlassBlock> ENLIGHTED_LABORATORY_GLASS = register("enlighted_laboratory_glass",
            () -> new LaboratoryGlassBlock(ModBlocks.LABORATORY_GLASS, BlockBehaviour.Properties.of().strength(0.3F).sound(SoundType.GLASS).noOcclusion().isValidSpawn(ModBlocks::never).isRedstoneConductor(ModBlocks::never).isSuffocating(ModBlocks::never).isViewBlocking(ModBlocks::never).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_OAK_LABORATORY_TILES = register("enlighted_oak_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.OAK_LABORATORY_TILES, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_SPRUCE_LABORATORY_TILES = register("enlighted_spruce_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.SPRUCE_LABORATORY_TILES, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_BIRCH_LABORATORY_TILES = register("enlighted_birch_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.BIRCH_LABORATORY_TILES, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_DARK_OAK_LABORATORY_TILES = register("enlighted_dark_oak_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.DARK_OAK_LABORATORY_TILES, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_JUNGLE_LABORATORY_TILES = register("enlighted_jungle_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.JUNGLE_LABORATORY_TILES, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_ACACIA_LABORATORY_TILES = register("enlighted_acacia_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.ACACIA_LABORATORY_TILES, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_MANGROVE_LABORATORY_TILES = register("enlighted_mangrove_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.MANGROVE_LABORATORY_TILES, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_CRIMSON_LABORATORY_TILES = register("enlighted_crimson_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.CRIMSON_LABORATORY_TILES, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_WARPED_LABORATORY_TILES = register("enlighted_warped_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.WARPED_LABORATORY_TILES, BlockBehaviour.Properties.of().ignitedByLava().strength(2.5F, 3.0F).sound(SoundType.WOOD).lightLevel((p_187433_) -> 10)));
