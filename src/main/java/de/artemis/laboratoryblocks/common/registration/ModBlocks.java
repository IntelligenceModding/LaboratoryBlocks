...
public class ModBlocks {
    ...
    public static final RegistryObject<DoorBlock> LABORATORY_DOOR = register("laboratory_door",
            () -> new DoorBlock(ModBlockSetTypes.LABORATORY, BlockBehaviour.Properties.of().strength(3.0F).noOcclusion().pushReaction(PushReaction.DESTROY)));
    ...
    public static final RegistryObject<TrapDoorBlock> LABORATORY_TRAPDOOR = register("laboratory_trapdoor",
            () -> new TrapDoorBlock(ModBlockSetTypes.LABORATORY, BlockBehaviour.Properties.of().strength(3.0F).noOcclusion().pushReaction(PushReaction.DESTROY)));
    ...
    public static final RegistryObject<LaboratorySignBlock> WARN_SIGN = register("warn_sign",
            () -> new LaboratorySignBlock(BlockBehaviour.Properties.of().strength(0.5F, 0.5F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<LaboratoryBlock> LABORATORY_PILLAR = register("laboratory_pillar",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_LABORATORY_PILLAR, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK)));

    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_LABORATORY_PILLAR = register("enlighted_laboratory_pillar",
            () -> new LaboratoryBlock(ModBlocks.LABORATORY_PILLAR, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));

    public static final RegistryObject<LaboratoryBlock> GRAY_LABORATORY_PILLAR = register("gray_laboratory_pillar",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_GRAY_LABORATORY_PILLAR, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_GRAY_LABORATORY_PILLAR = register("enlighted_gray_laboratory_pillar",
            () -> new LaboratoryBlock(ModBlocks.GRAY_LABORATORY_PILLAR, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));
    ...
    public static final RegistryObject<LaboratoryBlock> CLEAR_LABORATORY_SCREEN = register("clear_laboratory_screen",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_CLEAR_LABORATORY_SCREEN, BlockBehaviour.Properties.of().strength(1.25F, 1.5F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_CLEAR_LABORATORY_SCREEN = register("enlighted_clear_laboratory_screen",
            () -> new LaboratoryBlock(ModBlocks.CLEAR_LABORATORY_SCREEN, BlockBehaviour.Properties.of().strength(1.25F, 1.5F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));



    public static final RegistryObject<LaboratoryBlock> WAVE_LABORATORY_SCREEN = register("wave_laboratory_screen",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_WAVE_LABORATORY_SCREEN, BlockBehaviour.Properties.of().strength(1.25F, 1.5F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_WAVE_LABORATORY_SCREEN = register("enlighted_wave_laboratory_screen",
            () -> new LaboratoryBlock(ModBlocks.WAVE_LABORATORY_SCREEN, BlockBehaviour.Properties.of().strength(1.25F, 1.5F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));

    public static final RegistryObject<LaboratoryBlock> TEXT_LABORATORY_SCREEN = register("text_laboratory_screen",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_TEXT_LABORATORY_SCREEN, BlockBehaviour.Properties.of().strength(1.25F, 1.5F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_TEXT_LABORATORY_SCREEN = register("enlighted_text_laboratory_screen",
            () -> new LaboratoryBlock(ModBlocks.TEXT_LABORATORY_SCREEN, BlockBehaviour.Properties.of().strength(1.25F, 1.5F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));

    public static final RegistryObject<LaboratoryBlock> QUANTUM_LABORATORY_SCREEN = register("quantum_laboratory_screen",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_QUANTUM_LABORATORY_SCREEN, BlockBehaviour.Properties.of().strength(1.25F, 1.5F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_QUANTUM_LABORATORY_SCREEN = register("enlighted_quantum_laboratory_screen",
            () -> new LaboratoryBlock(ModBlocks.QUANTUM_LABORATORY_SCREEN, BlockBehaviour.Properties.of().strength(1.25F, 1.5F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));




    public static final RegistryObject<RedstoneControlledLaboratoryBlock> LABORATORY_FAN = register("laboratory_fan",
            () -> new RedstoneControlledLaboratoryBlock(ModBlocks.ENLIGHTED_LABORATORY_FAN, ModBlocks.LABORATORY_FAN_REDSTONE_CONTROLLED, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<RedstoneControlledLaboratoryBlock> ENLIGHTED_LABORATORY_FAN = register("enlighted_laboratory_fan",
            () -> new RedstoneControlledLaboratoryBlock(ModBlocks.LABORATORY_FAN, ModBlocks.ENLIGHTED_LABORATORY_FAN_REDSTONE_CONTROLLED, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));
    ...
    public static final RegistryObject<RedstoneControlledLaboratoryBlock> LABORATORY_FAN_REDSTONE_CONTROLLED = register("laboratory_fan_redstone_controlled",
            () -> new RedstoneControlledLaboratoryBlock(ModBlocks.ENLIGHTED_LABORATORY_FAN_REDSTONE_CONTROLLED, ModBlocks.LABORATORY_FAN, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<RedstoneControlledLaboratoryBlock> ENLIGHTED_LABORATORY_FAN_REDSTONE_CONTROLLED = register("enlighted_laboratory_fan_redstone_controlled",
            () -> new RedstoneControlledLaboratoryBlock(ModBlocks.LABORATORY_FAN_REDSTONE_CONTROLLED, ModBlocks.ENLIGHTED_LABORATORY_FAN, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));
    ...
    public static final RegistryObject<LaboratoryBlock> LEFT_FACED_BLUE_SIGNALING_LABORATORY_BLOCK = register("left-faced_blue_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_LEFT_FACED_BLUE_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_LEFT_FACED_BLUE_SIGNALING_LABORATORY_BLOCK = register("enlighted_left-faced_blue_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.LEFT_FACED_BLUE_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));
    ...
    public static final RegistryObject<LaboratoryBlock> RIGHT_FACED_BLUE_SIGNALING_LABORATORY_BLOCK = register("right-faced_blue_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_RIGHT_FACED_BLUE_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_RIGHT_FACED_BLUE_SIGNALING_LABORATORY_BLOCK = register("enlighted_right-faced_blue_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.RIGHT_FACED_BLUE_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));
    ...
    public static final RegistryObject<LaboratoryBlock> LEFT_FACED_RED_SIGNALING_LABORATORY_BLOCK = register("left-faced_red_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_LEFT_FACED_RED_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_LEFT_FACED_RED_SIGNALING_LABORATORY_BLOCK = register("enlighted_left-faced_red_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.LEFT_FACED_RED_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));
    ...
    public static final RegistryObject<LaboratoryBlock> RIGHT_FACED_RED_SIGNALING_LABORATORY_BLOCK = register("right-faced_red_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_RIGHT_FACED_RED_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_RIGHT_FACED_RED_SIGNALING_LABORATORY_BLOCK = register("enlighted_right-faced_red_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.RIGHT_FACED_RED_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));
    ...
    public static final RegistryObject<LaboratoryBlock> LEFT_FACED_GREEN_SIGNALING_LABORATORY_BLOCK = register("left-faced_green_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_LEFT_FACED_GREEN_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_LEFT_FACED_GREEN_SIGNALING_LABORATORY_BLOCK = register("enlighted_left-faced_green_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.LEFT_FACED_GREEN_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));
    ...
    public static final RegistryObject<LaboratoryBlock> RIGHT_FACED_GREEN_SIGNALING_LABORATORY_BLOCK = register("right-faced_green_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_RIGHT_FACED_GREEN_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_RIGHT_FACED_GREEN_SIGNALING_LABORATORY_BLOCK = register("enlighted_right-faced_green_signaling_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.RIGHT_FACED_GREEN_SIGNALING_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));

    public static final RegistryObject<LaboratoryBlock> LABORATORY_BOOKSHELF = register("laboratory_bookshelf",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_LABORATORY_BOOKSHELF, BlockBehaviour.Properties.of().strength(1.5F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_LABORATORY_BOOKSHELF = register("enlighted_laboratory_bookshelf",
            () -> new LaboratoryBlock(ModBlocks.LABORATORY_BOOKSHELF, BlockBehaviour.Properties.of().strength(1.5F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));
    ...
    public static final RegistryObject<ChiseledLaboratoryBookShelfBlock> CHISELED_LABORATORY_BOOKSHELF = register("chiseled_laboratory_bookshelf",
            () -> new ChiseledLaboratoryBookShelfBlock(ModBlocks.ENLIGHTED_CHISELED_LABORATORY_BOOKSHELF, BlockBehaviour.Properties.of().strength(1.5F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<ChiseledLaboratoryBookShelfBlock> ENLIGHTED_CHISELED_LABORATORY_BOOKSHELF = register("enlighted_chiseled_laboratory_bookshelf",
            () -> new ChiseledLaboratoryBookShelfBlock(ModBlocks.CHISELED_LABORATORY_BOOKSHELF, BlockBehaviour.Properties.of().strength(1.5F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));

    public static final RegistryObject<LaboratoryBlock> LABORATORY_VENT = register("laboratory_vent",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_LABORATORY_VENT, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK)));

    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_LABORATORY_VENT = register("enlighted_laboratory_vent",
            () -> new LaboratoryBlock(ModBlocks.LABORATORY_VENT, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));

    public static final RegistryObject<LaboratoryBlock> LABORATORY_VENT_CONNECTING = register("laboratory_vent_connecting",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_LABORATORY_VENT_CONNECTING, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_LABORATORY_VENT_CONNECTING = register("enlighted_laboratory_vent_connecting",
            () -> new LaboratoryBlock(ModBlocks.LABORATORY_VENT_CONNECTING, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));
    ...
    public static final RegistryObject<LaboratoryBlock> LABORATORY_BLOCK = register("laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK)));

    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_LABORATORY_BLOCK = register("enlighted_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));

    public static final RegistryObject<LaboratoryBlock> SCREWED_LABORATORY_BLOCK = register("screwed_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_SCREWED_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_SCREWED_LABORATORY_BLOCK = register("enlighted_screwed_laboratory_block",
            () -> new LaboratoryBlock(ModBlocks.SCREWED_LABORATORY_BLOCK, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));

    public static final RegistryObject<LaboratoryBlock> LABORATORY_TILES = register("laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_LABORATORY_TILES, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK)));

    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_LABORATORY_TILES = register("enlighted_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.LABORATORY_TILES, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));

    public static final RegistryObject<LaboratoryBlock> GRAY_LABORATORY_TILES = register("gray_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_GRAY_LABORATORY_TILES, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_GRAY_LABORATORY_TILES = register("enlighted_gray_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.GRAY_LABORATORY_TILES, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));

    public static final RegistryObject<LaboratoryBlock> MIXED_LABORATORY_TILES = register("mixed_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.ENLIGHTED_MIXED_LABORATORY_TILES, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK)));
    ...
    public static final RegistryObject<LaboratoryBlock> ENLIGHTED_MIXED_LABORATORY_TILES = register("enlighted_mixed_laboratory_tiles",
            () -> new LaboratoryBlock(ModBlocks.MIXED_LABORATORY_TILES, BlockBehaviour.Properties.of().strength(2.5F, 3.0F).sound(ModSoundTypes.LABORATORY_BLOCK).lightLevel((p_187433_) -> 14)));
