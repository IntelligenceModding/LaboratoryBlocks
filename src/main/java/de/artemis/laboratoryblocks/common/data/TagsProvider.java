...
public class TagsProvider {
    public static class BlockTagsProvider extends net.minecraft.data.tags.TagsProvider<Block> {
        ...
        protected void addTags(@NotNull HolderLookup.Provider provider) {
            tag(BlockTags.MINEABLE_WITH_PICKAXE).add(getKey(ModBlocks.LABORATORY_LADDER.get())).add(getKey(ModBlocks.LABORATORY_TRAPDOOR.get())).add(getKey(ModBlocks.MESH_LABORATORY_TRAPDOOR.get())).add(getKey(ModBlocks.GLASS_LABORATORY_TRAPDOOR.get())).add(getKey(ModBlocks.GLASS_LABORATORY_DOOR.get())).add(getKey(ModBlocks.MESH_LABORATORY_DOOR.get())).add(getKey(ModBlocks.LABORATORY_DOOR.get())).add(getKey(ModBlocks.ENLIGHTED_LABORATORY_VENT_CONNECTING.get())).add(getKey(ModBlocks.LABORATORY_VENT_CONNECTING.get())).add(getKey(ModBlocks.LABORATORY_FAN_REDSTONE_CONTROLLED.get())).add(getKey(ModBlocks.ENLIGHTED_LABORATORY_FAN_REDSTONE_CONTROLLED.get())).add(getKey(ModBlocks.LABORATORY_BLOCK.get())).add(getKey(ModBlocks.ENLIGHTED_LABORATORY_BLOCK.get())).add(getKey(ModBlocks.LABORATORY_TILES.get())).add(getKey(ModBlocks.ENLIGHTED_LABORATORY_TILES.get())).add(getKey(ModBlocks.GRAY_LABORATORY_TILES.get())).add(getKey(ModBlocks.ENLIGHTED_GRAY_LABORATORY_TILES.get())).add(getKey(ModBlocks.MIXED_LABORATORY_TILES.get())).add(getKey(ModBlocks.ENLIGHTED_MIXED_LABORATORY_TILES.get())).add(getKey(ModBlocks.LABORATORY_VENT.get())).add(getKey(ModBlocks.ENLIGHTED_LABORATORY_VENT.get())).add(getKey(ModBlocks.LEFT_FACED_BLUE_SIGNALING_LABORATORY_BLOCK.get())).add(getKey(ModBlocks.ENLIGHTED_LEFT_FACED_BLUE_SIGNALING_LABORATORY_BLOCK.get())).add(getKey(ModBlocks.RIGHT_FACED_BLUE_SIGNALING_LABORATORY_BLOCK.get())).add(getKey(ModBlocks.ENLIGHTED_RIGHT_FACED_BLUE_SIGNALING_LABORATORY_BLOCK.get())).add(getKey(ModBlocks.LEFT_FACED_RED_SIGNALING_LABORATORY_BLOCK.get())).add(getKey(ModBlocks.ENLIGHTED_LEFT_FACED_RED_SIGNALING_LABORATORY_BLOCK.get())).add(getKey(ModBlocks.RIGHT_FACED_RED_SIGNALING_LABORATORY_BLOCK.get())).add(getKey(ModBlocks.ENLIGHTED_RIGHT_FACED_RED_SIGNALING_LABORATORY_BLOCK.get())).add(getKey(ModBlocks.LEFT_FACED_GREEN_SIGNALING_LABORATORY_BLOCK.get())).add(getKey(ModBlocks.ENLIGHTED_LEFT_FACED_GREEN_SIGNALING_LABORATORY_BLOCK.get())).add(getKey(ModBlocks.RIGHT_FACED_GREEN_SIGNALING_LABORATORY_BLOCK.get())).add(getKey(ModBlocks.ENLIGHTED_RIGHT_FACED_GREEN_SIGNALING_LABORATORY_BLOCK.get())).add(getKey(ModBlocks.LABORATORY_FAN.get())).add(getKey(ModBlocks.ENLIGHTED_LABORATORY_FAN.get())).add(getKey(ModBlocks.SCREWED_LABORATORY_BLOCK.get())).add(getKey(ModBlocks.ENLIGHTED_SCREWED_LABORATORY_BLOCK.get())).add(getKey(ModBlocks.CLEAR_LABORATORY_SCREEN.get())).add(getKey(ModBlocks.ENLIGHTED_CLEAR_LABORATORY_SCREEN.get())).add(getKey(ModBlocks.WAVE_LABORATORY_SCREEN.get())).add(getKey(ModBlocks.ENLIGHTED_WAVE_LABORATORY_SCREEN.get())).add(getKey(ModBlocks.TEXT_LABORATORY_SCREEN.get())).add(getKey(ModBlocks.QUANTUM_LABORATORY_SCREEN.get())).add(getKey(ModBlocks.ENLIGHTED_QUANTUM_LABORATORY_SCREEN.get())).add(getKey(ModBlocks.ENLIGHTED_TEXT_LABORATORY_SCREEN.get())).add(getKey(ModBlocks.LABORATORY_PILLAR.get())).add(getKey(ModBlocks.ENLIGHTED_LABORATORY_PILLAR.get())).add(getKey(ModBlocks.GRAY_LABORATORY_PILLAR.get())).add(getKey(ModBlocks.ENLIGHTED_GRAY_LABORATORY_PILLAR.get())).add(getKey(ModBlocks.LABORATORY_BOOKSHELF.get())).add(getKey(ModBlocks.ENLIGHTED_LABORATORY_BOOKSHELF.get())).add(getKey(ModBlocks.CHISELED_LABORATORY_BOOKSHELF.get())).add(getKey(ModBlocks.ENLIGHTED_CHISELED_LABORATORY_BOOKSHELF.get()));
            ...
            tag(BlockTags.ENCHANTMENT_POWER_PROVIDER).add(getKey(ModBlocks.LABORATORY_BOOKSHELF.get()), getKey(ModBlocks.ENLIGHTED_LABORATORY_BOOKSHELF.get()));
            tag(BlockTags.DOORS).add(getKey(ModBlocks.GLASS_LABORATORY_DOOR.get())).add(getKey(ModBlocks.MESH_LABORATORY_DOOR.get())).add(getKey(ModBlocks.LABORATORY_DOOR.get()));
            tag(BlockTags.TRAPDOORS).add(getKey(ModBlocks.LABORATORY_TRAPDOOR.get())).add(getKey(ModBlocks.MESH_LABORATORY_TRAPDOOR.get())).add(getKey(ModBlocks.GLASS_LABORATORY_TRAPDOOR.get()));
            tag(BlockTags.CLIMBABLE).add(getKey(ModBlocks.LABORATORY_LADDER.get()));
        }
